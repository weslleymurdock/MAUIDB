...
A collation is a special pragma (for more info, see [Pragmas](~/articles/pragmas/index.md)) that allows users to specify a culture and string compare options for a datafile.
