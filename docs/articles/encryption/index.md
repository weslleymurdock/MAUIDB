...
The password for an encrypted datafile is defined in the connection string (for more info, check [Connection String](~/articles/connection-string/index.md)). The password can only be changed or removed by rebuilding the datafile (for more info, check Rebuild Options in [Pragmas](~/articles/pragmas/index.md#rebuild-options)).
